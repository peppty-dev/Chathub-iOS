    ...
    func createrecenttable() {
            ...
            DatabaseManager.shared.executeOnDatabaseQueueAsync { db in
                ...
                for entry in corruptedEntries {
                    ...
                    if sqlite3_prepare_v2(db, gameQueryString, -1, &gameQueryStatement, nil) == SQLITE_OK {
                        sqlite3_bind_text(gameQueryStatement, 1, entry.gameId, -1, nil)
                        ...
                        if sqlite3_step(gameQueryStatement) == SQLITE_ROW {
                            ...
                            if !gameName.isEmpty {
                                ...
                                if sqlite3_prepare_v2(db, updateString, -1, &updateStatement, nil) == SQLITE_OK {
                                    sqlite3_bind_text(updateStatement, 1, gameUrl, -1, nil)
                                    sqlite3_bind_text(updateStatement, 2, gameName, -1, nil)
                                    sqlite3_bind_text(updateStatement, 3, gameDescription, -1, nil)
                                    sqlite3_bind_text(updateStatement, 4, gameIcon, -1, nil)
                                    sqlite3_bind_text(updateStatement, 5, gameCover, -1, nil)
                                    sqlite3_bind_text(updateStatement, 6, gameRating, -1, nil)
                                    sqlite3_bind_int(updateStatement, 7, Int32(gamePlays))
                                    sqlite3_bind_int(updateStatement, 8, Int32(multiplayer))
                                    sqlite3_bind_text(updateStatement, 9, entry.gameId, -1, nil)
        ...
        func insert(_ games_table: Games_Table) {
            ...
            """
                ...
                if sqlite3_prepare_v2(db, insertString, -1, &insertStatement, nil) == SQLITE_OK {
                    sqlite3_bind_text(insertStatement, 1, games_table.game_id, -1, nil)
                    sqlite3_bind_text(insertStatement, 2, games_table.game_url, -1, nil)
                    sqlite3_bind_text(insertStatement, 3, games_table.game_name, -1, nil)
                    sqlite3_bind_text(insertStatement, 4, games_table.game_description, -1, nil)
                    sqlite3_bind_text(insertStatement, 5, games_table.game_icon, -1, nil)
                    sqlite3_bind_text(insertStatement, 6, games_table.game_cover, -1, nil)
                    sqlite3_bind_text(insertStatement, 7, games_table.game_rating, -1, nil)
                    sqlite3_bind_text(insertStatement, 8, games_table.game_plays, -1, nil)
                    sqlite3_bind_text(insertStatement, 9, games_table.game_type, -1, nil)
        ...
        func selectGames() -> [Games_Table] {
            ...
            let result = DatabaseManager.shared.executeReadQuery(
                ...
                AppLogger.log(tag: "LOG-APP: GamesDB", message: "selectGames() Retrieved \(games.count) games")
                return games
            }
        ...
        func setGamePlayedTime(game_id: String, time: Int64) {
            DatabaseManager.shared.executeOnDatabaseQueueAsync { db in
                ...
                if sqlite3_prepare_v2(db, updateString, -1, &updateStatement, nil) == SQLITE_OK {
                    ...
                    sqlite3_bind_text(updateStatement, 2, game_id, -1, nil)
        ...
        func insertMinimalGameEntry(gameId: String, timestamp: Int64) {
            ...
            """
                var insertStatement: OpaquePointer?
                if sqlite3_prepare_v2(db, insertString, -1, &insertStatement, nil) == SQLITE_OK {
                    sqlite3_bind_text(insertStatement, 1, gameId, -1, nil)
                    sqlite3_bind_text(insertStatement, 2, "Game \(gameId)", -1, nil)
